...
public class JdbcTemplate {
	...
	//template method
    public final Object execute(String sql, ResultSetCallback rsb) throws SQLException, ClassNotFoundException{
        ...
        try {
            ...
            Object result = rsb.doInStatement(rs);//abstract method
            return result;
        }
    ...
    public Object query(String sql, ResultSetCallback rsb) throws SQLException, ClassNotFoundException{
        return execute(sql, rsb);
    }
